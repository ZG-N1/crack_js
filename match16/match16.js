//遇到最大的坑是两个大数组在运行时顺序变了，运行中其实有观察到，
//但还是先入为主看到源代码中的数组直接复制来用会报TypeError: i.eMnqD is not a function
//奇怪明明手动推敲代码是能解析出i.eMnqD的。
// _0x4c28 大数组定义时，后面还定义了自执行函数，所以会使数组顺序变化
// 还要注意数组的引用是浅复制, e变化实际上就是_0x4c28 变化
// 最后弄明白后数组_0x34e7也可以使用原数组，不过需要使用修复后的代码片段_0x34e7_fixed
var _0x34e7 = [
  "split",
  "ABHICESQWK",
  "FKByN",
...
(_0x4c28 = [
  ...
  //_0x4c28数组的值使用了原始值，下方是自执行函数改变顺序
  (e = _0x4c28),
  (t = 368),
  (function (t) {
...
function window_md5(e) {
  ...
  (r[t(3)] = function (e, t) {
    ...
    (r[t(11)] =
      t(126) + t(128) + "UVWXYZabcdefghijklmn" + t(21) + "yz01234567" + t(139)),
    (r[t(63)] = function (e, t) {
      return e * t;
    }),
...
function btoa(e) {
  ...
  for (var o, a, s, l = 0, c = []; l < e[t(261)]; ) {
    switch (((a = e[t(237)](l)), (s = i.kukBH(l, 6)))) {
      ...
      case 1:
        try {
          // "WhHMm" === i[t(198)] ||
          // (n.g && c[t(246)](f[t(245)](i.pHtmC(2 & o, 3) | i.evetF(a, 4))));//此处是环境检测
  ...
  return (
    ...
    i[t(219)](i.aQCDK(d(15), window_md5(c[t(234)](""))), i[t(220)](d, 10))
  );
}
